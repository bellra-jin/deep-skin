...
라벨 자체를 바꾸는 실험을 했습니다. 0~5의 6개 등급을 **양호 / 보통 / 주의** 3등급으로 묶은 것입니다.
...
```text
3-grade ordinal ResNet-50 training curve (16 epochs)
...
**문제**
5등급을 3등급으로 병합해 macro-F1 0.665를 얻은 뒤, 여기에 데이터 균형 보정을 추가로 적용했습니다. 더 좋아질 것이라 예상했지만 결과는 **0.665 → 0.644, accuracy 0.728 → 0.703**으로 하락했습니다.
